...
def handler(event, context):
    """
    MCP list_tools: 返回所有可用工具的 schema
    """
    tools = [
        {
            "name": "detect_league",
        ...
        },
        {
            ...
            "description": (
                ...
                "The league must be obtained through detect_league first."
            ),
            "parameters": {
                "type": "object",
                "properties": {
        ...
        },
        {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "result": {
                        "type": "string",
                        "description": "Match result for the team: win, draw, or lose"
                    },
                    "home_or_away": {
                        "type": "string",
                        "description": "Whether the team played at home or away: home or away"
                    }
                },
